...
<div class="gmw-results-wrapper gmw-results-wrapper-<?php echo $gmw['ID']; ?> gmw-pt-results-wrapper">
	...
	<!--  Results wrapper -->
	<div class="gmw-posts-wrapper ddd">
		...
		<?php while ( $gmw_query->have_posts() ) : $gmw_query->the_post(); ?>
			...
			<div id="post-<?php the_ID(); ?>" <?php post_class( 'wppl-single-result '.$featured ); ?>>
				...
				<!-- Title -->
				<h2>
					<a href="<?php echo the_permalink(); ?>"><img id="gmw-locate-button-1" class="gmw-locate-btn gmw-locator-submit" src="<?php echo site_url(); ?>/wp-content/plugins/GEO-my-WP-master/assets/images/locator-images/red-dot.png" alt="locator button"> <?php the_title(); ?></a>
