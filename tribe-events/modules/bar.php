...
<?php do_action( 'tribe_events_bar_before_template' ) ?>
    <div class="md-before-filter"><p>To find a screening near you please enter your postcode/zip or City name and then click the green "Search" button. To book tickets please click on the yellow links for each cinema to be taken to their website and check availability.</p></div>
