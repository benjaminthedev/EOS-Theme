...
/*get the custom field for booking link */
$booklink = get_field('book_tickets',$EM_Event->post_id);
if(isset($booklink) && !empty($booklink)){
	echo '<div class="booking-link"><a class="bookticket-btn" href="'.$booklink.'">Book Ticket</a></div>';
}
