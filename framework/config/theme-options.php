...
global $us_template_directory_uri, $wp_registered_sidebars, $usof_image_sizes_select_values, $usof_enable_portfolio;
// Getting Sidebars
$sidebars_options = array();
if ( ! isset( $usof_image_sizes_select_values ) ) {
	$usof_image_sizes_select_values = array();
}
...
return array(
	...
	'layoutoptions' => array(
		...
		'fields' => array(
			...
			'body_bg_image_size' => array(
				...
				'std' => 'cover',
				'classes' => 'layout_switch width_full',
			),
			...
			'body_bg_image_position' => array(
				...
				'std' => 'top left',
				'classes' => 'layout_switch bgpos width_full',
			),
	...
	'portfoliooptions' => array(
		...
		'fields' => array(
			...
			'portfolio_sidebar_id' => array(
				...
				'options' => $sidebars_options,
				'std' => 'default_sidebar',
				'show_if' => array( 'portfolio_sidebar', '!=', 'none' ),
			),
			...
			'portfolio_prevnext_category' => array(
				...
				'type' => 'switch',
				'text' => __( 'Enable previous/next portfolio page navigation within a category', 'us' ),
				'std' => 0,
				'show_if' => array( 'portfolio_sided_nav', '=', TRUE ),
			),
			'h_portfolio_2' => array(
	...
	'blogoptions' => array(
		...
		'fields' => array(
			...
			'post_preview_img_size' => array(
				...
				'type' => 'select',
				'options' => $usof_image_sizes_select_values,
				'std' => 'large',
			...
			'post_sidebar_id' => array(
				...
				'options' => $sidebars_options,
				'std' => 'default_sidebar',
				'show_if' => array( 'post_sidebar', '!=', 'none' ),
			),
			'post_meta' => array(
			...
			'post_related_img_size' => array(
				...
				'std' => 'tnail-1x1-small',
				'show_if' => array(
					array( 'post_related', '=', TRUE ),
					'and',
					array( 'post_related_layout', '=', 'related' ),
				),
			),
			'h_blog_2' => array(
			...
			'blog_img_size' => array(
				'title' => __( 'Images Size', 'us' ),
				'type' => 'select',
				'options' => array_merge( array( 'default' => us_translate( 'Default' ) ), $usof_image_sizes_select_values ),
				'std' => 'default',
	...
	'advanced' => array(
		...
		'fields' => array(
			...
			'enable_portfolio' => array(
				'type' => 'switch',
				'text' => __( 'Enable Portfolio module', 'us' ),
				'std' => 1,
				'classes' => 'width_full desc_2',
			),
			'enable_testimonials' => array(
				'type' => 'switch',
				'text' => __( 'Enable Testimonials module', 'us' ),
				'std' => 1,
				'classes' => 'width_full desc_2',
			),
			'h_advanced_2' => array(
			...
			'lazyload_fonts' => array(
				...
				'description' => __( 'When this option is ON, Google Fonts files will be loaded after page content. This will improve page loading speed.', 'us' ),
				'std' => 0,
				'classes' => 'width_full desc_2',
			),
	...
	'code' => array(
		...
		'icon' => $us_template_directory_uri . '/framework/admin/img/usof/code.png',
		'fields' => array(
			'custom_css' => array(
