...
function us_theme_options_page() {
	...
	global $usof_directory, $usof_options, $usof_image_sizes_select_values, $usof_enable_portfolio;
	...
	$usof_image_sizes_select_values = array_flip( us_image_sizes_select_values() );
