...
<body <?php body_class( 'l-body tribe-filter-live tribe-events-uses-geolocation customize-support tribe-is-responsive tribe-filters-open' . $us_layout->body_classes() ) ?><?php echo $us_layout->body_styles() ?> itemscope="itemscope" itemtype="https://schema.org/WebPage">
